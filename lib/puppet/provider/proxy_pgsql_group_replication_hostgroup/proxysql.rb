...
Puppet::Type.type(:proxy_pgsql_group_replication_hostgroup).provide(:proxysql, parent: Puppet::Provider::Proxysql) do
  ...
  def self.instances
    ...
    hostgroups = mysql([defaults_file, '-NBe',
                        'SELECT `writer_hostgroup`, `backup_writer_hostgroup`, `reader_hostgroup`, `offline_hostgroup`, `active`, `max_writers`, `writer_is_also_reader`, `max_transactions_behind`, `comment` FROM `pgsql_group_replication_hostgroups`'].compact).split(%r{\n})
  ...
  # We iterate over each proxy_pgsql_group_replication_hostgroup entry in the catalog and compare it against
  ...
  def create
    ...
    query = 'INSERT INTO `pgsql_group_replication_hostgroups` (`writer_hostgroup`, `backup_writer_hostgroup`, `reader_hostgroup`, `offline_hostgroup`, `active`, `max_writers`, `writer_is_also_reader`, `max_transactions_behind`, `comment`) ' \
  ...
  def destroy
    ...
    query = 'DELETE FROM `pgsql_group_replication_hostgroups`'
  ...
  def active=(value)
    ...
    reader_hostgroup = @resource.value(:reader_hostgroup)
    offline_hostgroup = @resource.value(:offline_hostgroup)
    query = "UPDATE pgsql_group_replication_hostgroups SET `active` = #{value} " \
  ...
  def max_writers=(value)
    ...
    reader_hostgroup = @resource.value(:reader_hostgroup)
    offline_hostgroup = @resource.value(:offline_hostgroup)
    query = "UPDATE pgsql_group_replication_hostgroups SET `max_writers=` = #{value} " \
            "WHERE `writer_hostgroup` =  #{writer_hostgroup} AND `backup_writer_hostgroup` = #{backup_writer_hostgroup} AND `reader_hostgroup` = #{reader_hostgroup} AND `offline_hostgroup` = #{offline_hostgroup}"
    mysql([defaults_file, '-e', query].compact)
  ...
  def writer_is_also_reader=(value)
    ...
    reader_hostgroup = @resource.value(:reader_hostgroup)
    offline_hostgroup = @resource.value(:offline_hostgroup)
    query = "UPDATE pgsql_group_replication_hostgroups SET `writer_is_also_reader` = #{value} " \
            "WHERE `writer_hostgroup` =  #{writer_hostgroup} AND `backup_writer_hostgroup` = #{backup_writer_hostgroup} AND `reader_hostgroup` = #{reader_hostgroup} AND `offline_hostgroup` = #{offline_hostgroup}"
    mysql([defaults_file, '-e', query].compact)
  ...
  def max_transactions_behind=(value)
    ...
    reader_hostgroup = @resource.value(:reader_hostgroup)
    offline_hostgroup = @resource.value(:offline_hostgroup)
    query = "UPDATE pgsql_group_replication_hostgroups SET `max_transactions_behind=` = #{value} " \
            "WHERE `writer_hostgroup` =  #{writer_hostgroup} AND `backup_writer_hostgroup` = #{backup_writer_hostgroup} AND `reader_hostgroup` = #{reader_hostgroup} AND `offline_hostgroup` = #{offline_hostgroup}"
    mysql([defaults_file, '-e', query].compact)
  ...
  def comment=(value)
    ...
    reader_hostgroup = @resource.value(:reader_hostgroup)
    offline_hostgroup = @resource.value(:offline_hostgroup)
    query = "UPDATE pgsql_group_replication_hostgroups SET `comment` = '#{value}' " \
            "WHERE `writer_hostgroup` =  #{writer_hostgroup} AND `backup_writer_hostgroup` = #{backup_writer_hostgroup} AND `reader_hostgroup` = #{reader_hostgroup} AND `offline_hostgroup` = #{offline_hostgroup}"
    mysql([defaults_file, '-e', query].compact)
